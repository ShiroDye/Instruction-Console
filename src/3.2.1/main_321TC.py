...
root = Tk()
root.title ("指令序列主控台 Version 3.2.1 By W~Z~C@Ahiro Studios")
...
Label(f_top, text="指令序列控制台 Version 3.2.1", fg='white', bg='#3b3e4b', font=('Microsoft JhengHei', 11)).pack(pady=5)
