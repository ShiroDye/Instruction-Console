...
root = Tk()
root.title("Instruction Sequence Console Version 3.2.0 By ShiroDye")
...
Label(f_top, text="Instruction Sequence Console Version 3.2.0", fg='white', bg='#3b3e4b', font=('Arial', 11, 'bold')).pack(pady=5)
